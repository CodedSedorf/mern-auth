...
export const register = async (req, res) => {
  ...
  try {
    ...
    //Sending welcome email using nodemailer config
    const mailOptions = {
...
//Gets OTP and verify email using OTP (Email veriication function)
...
export const sendResetOtp = async (req, res) => {
  ...
  try {
    ...
    const mailOption = {
      ...
      text: `Your OTP for setting your password is ${otp}. Use this OTP to proceed with resetting your password`,
    };
    await transporter.sendMail(mailOption);
    return res.json({
      success: true,
      message:
        "OTP is sent to your email successfully for resetting your password",
    });
  } catch (error) {
    return res.json({ success: false, message: error.message });
  }
